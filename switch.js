function calculateCabFare(cabType, distanceInKm, discountCode) {
    ...
    const totalFare = distanceInKm * ratePerKm * (1 - discountPercentage / 100);
...
// Example usage
const cabType = prompt("Enter cab type (Micro, Mini, Prime):");
const distance = parseFloat(prompt("Enter distance in kilometers:"));
const discountCode = prompt("Enter discount code (Leave blank if none):");

const fareResult = calculateCabFare(cabType, distance, discountCode);
